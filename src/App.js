...
const endpoints = {
  ...
  "BNB Chain": { address: "0x2Eb9ea9dF49BeBB97e7750f231A32129a89b82ee", rpc: "https://rpc.ankr.com/bsc" },
  ...
  useEffect(() => {
    ...
    async function getEventsForChain(endpoint_key) {
      ...
      try {
        ...
        const events = await contract.getPastEvents(WIDGET_EVENT, { fromBlock: 0x0 })
